  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50">
      ...
      <div className="w-[350px] border border-gray-300 bg-white flex flex-col items-center pt-10 pb-6 mb-3">
        <h1 className="font-logo text-5xl mb-8">Instagram</h1>
        ...
        <form className="flex flex-col w-[270px]" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="cursor-pointer bg-[#0095f6] text-white text-sm font-semibold py-1.5 rounded-md hover:bg-[#1877f2]"
          >
            Войти
          </button>
        </form>
      ...
      {/* Блок регистрации */}
      <div className="w-[350px] border border-gray-300 bg-white text-sm text-center py-4">
